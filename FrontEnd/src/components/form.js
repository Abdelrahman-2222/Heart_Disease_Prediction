...
//         this.handleSubmit = this.handleSubmit.bind(this); // bind handleSubmit to class context
//     }
//
...
//         setFormData({
//             ...formData,
//             [name]: isBoolean.includes(name) ? event.target.value === 'true' : value,
//         });
//     };
//
//     return (
    ...
    render() {
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <Button href='/patientsList' type="submit" value="submit">Submit</Button>
            </form>
        )
    }
}
