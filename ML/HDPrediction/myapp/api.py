...
from ML.HDPrediction.myapp.serializers import HeartSerializer
...
#
# class HeartDiseaseList(generics.ListAPIView):
#     permission_classes = (AllowAny,)
#     queryset = HeartDisease.objects.all()
#     serializer_class = HeartSerializer
#
...
#
#
# class HeartDiseaseDetail(generics.RetrieveAPIView):
#     permission_classes = (AllowAny,)
#     queryset = HeartDisease.objects.all()
#     serializer_class = HeartSerializer
#
#
# class HeartDiseaseNameList(generics.ListAPIView):
#     permission_classes = (AllowAny,)
#     serializer_class = HeartSerializer
#
#     def get_queryset(self):
#         name = self.kwargs['name']
#         return HeartDisease.objects.filter(first_name=name)
...
#         # Set the prediction field of the HeartDisease instance
#         instance.prediction = prediction
#
#         # Save the instance again, this time with the prediction field set
#         instance.save()
